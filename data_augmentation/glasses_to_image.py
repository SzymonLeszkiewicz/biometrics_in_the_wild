...
def overlay(image, filter_img, face_landmarks, face_part, INDEXES, display=True):
    ...
    try:
        ...
        if face_part == "MOUTH":
            ...
            location = (
                int(center[0] - filter_img_width / 1.3),
...
if __name__ == "__main__":
    ...
    img = apply_glasses_to_image("data/0.jpg", "data_augmentation/filters/glasses2.png")
    cv2.imwrite("data/0_glasses.jpg", img)

    img = apply_glasses_to_image("data/1.jpg", "data_augmentation/filters/glasses2.png")
    cv2.imwrite("data/1_glasses.jpg", img)
    # img = apply_glasses_to_image('media/sample2.jpg', 'media/glasses2.png')
